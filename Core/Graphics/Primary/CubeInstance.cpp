...
CubeInstanced::CubeInstanced(ISwapChain* pSwapChain, IRenderDevice* pRenderDevice, IEngineFactory *pEngineFactory, IDeviceContext* pDeviceContext)
...
void CubeInstanced::Update(float eplapsedTime, float4x4 matrix)
{
	m_ModelMatrix = matrix;
}

void CubeInstanced::Draw()
{
	{
...
void CubeInstanced::CreatePipeline()
{
	//VERTEX BUFFER
...
void CubeInstanced::LoadTexture()
{
